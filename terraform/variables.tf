...
variable "azure_reuse_config" {
  ...
  type = object({
    aoai_reuse                                                 = optional(bool, false)
    existing_aoai_resource_group_name                         = optional(string, "")
    existing_aoai_name                                        = optional(string, "")
    app_insights_reuse                                        = optional(bool, false)
    existing_app_insights_resource_group_name                 = optional(string, "")
    existing_app_insights_name                                = optional(string, "")
    log_analytics_workspace_reuse                             = optional(bool, false)
    existing_log_analytics_workspace_resource_id              = optional(string, "")
    app_service_plan_reuse                                    = optional(bool, false)
    existing_app_service_plan_resource_group_name             = optional(string, "")
    existing_app_service_plan_name                            = optional(string, "")
    ai_search_reuse                                           = optional(bool, false)
    existing_ai_search_resource_group_name                    = optional(string, "")
    existing_ai_search_name                                   = optional(string, "")
    ai_services_reuse                                         = optional(bool, false)
    existing_ai_services_resource_group_name                  = optional(string, "")
    existing_ai_services_name                                 = optional(string, "")
    cosmos_db_reuse                                           = optional(bool, false)
    existing_cosmos_db_resource_group_name                    = optional(string, "")
    existing_cosmos_db_account_name                           = optional(string, "")
    existing_cosmos_db_database_name                          = optional(string, "")
    key_vault_reuse                                           = optional(bool, false)
    existing_key_vault_resource_group_name                    = optional(string, "")
    existing_key_vault_name                                   = optional(string, "")
    storage_reuse                                             = optional(bool, false)
    existing_storage_resource_group_name                      = optional(string, "")
    existing_storage_name                                     = optional(string, "")
    vnet_reuse                                                = optional(bool, false)
    existing_vnet_resource_group_name                         = optional(string, "")
    existing_vnet_name                                        = optional(string, "")
    orchestrator_function_app_reuse                           = optional(bool, false)
    existing_orchestrator_function_app_resource_group_name    = optional(string, "")
    existing_orchestrator_function_app_name                   = optional(string, "")
    data_ingestion_function_app_reuse                         = optional(bool, false)
    existing_data_ingestion_function_app_resource_group_name  = optional(string, "")
    existing_data_ingestion_function_app_name                 = optional(string, "")
    app_service_reuse                                         = optional(bool, false)
    existing_app_service_name                                 = optional(string, "")
    existing_app_service_name_resource_group_name             = optional(string, "")
    orchestrator_function_app_storage_reuse                   = optional(bool, false)
    existing_orchestrator_function_app_storage_name           = optional(string, "")
    existing_orchestrator_function_app_storage_resource_group_name = optional(string, "")
    data_ingestion_function_app_storage_reuse                 = optional(bool, false)
    existing_data_ingestion_function_app_storage_name         = optional(string, "")
    existing_data_ingestion_function_app_storage_resource_group_name = optional(string, "")
  })
  default = {}
}
